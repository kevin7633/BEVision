...
exp_name = os.environ.get(
    'BEVFUSION_EXP_NAME',
    f'bevfusion_mini_feature_gate_cam-{camera_corruption_type}_lidar-'
...
test_pipeline += [
    dict(type='BEVFusionSensorReliabilityProxy', lidar_count_ref=300000.0),
    dict(
        type='ImageAug3D',
        final_dim=[256, 704],
    ...
    dict(
        ...
        meta_keys=[
            ...
            'camera_reliability_proxy', 'camera_brightness',
            'camera_contrast', 'camera_sharpness', 'lidar_reliability_proxy',
            'lidar_point_count'
        ])
]
