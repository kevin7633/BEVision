...
test_evaluator = dict(
    jsonfile_prefix='/workspace/outputs/bevfusion_mini_camera_lidar_all_moderate/results')
work_dir = '/workspace/work_dirs/bevfusion_mini_camera_lidar_all_moderate'
