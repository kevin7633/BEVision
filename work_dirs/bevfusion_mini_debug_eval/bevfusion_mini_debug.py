...
launcher = 'none'
load_from = 'work_dirs/bevfusion_mini_debug_smoke/epoch_1.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ann_file='data/nuscenes/nuscenes_mini_infos_val.pkl',
    backend_args=None,
    data_root='data/nuscenes/',
    metric='bbox',
    type='NuScenesMetric')
...
work_dir = 'work_dirs/bevfusion_mini_debug_eval'
